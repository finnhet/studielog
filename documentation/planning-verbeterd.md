...
- **10:15–11:00 (0:45) – Projectplan – Projectomgeving in kaart brengen**  
	De huidige versie van StudieLog verkennen en in het Projectplan kort beschrijven hoe het project is opgebouwd (wat er al is, wat nog niet).

- **11:00–12:00 (1:00) – Projectplan – Sjablonen afronden**  
	Sjablonen voor Projectplan, Functioneel ontwerp, Technisch ontwerp en Testplan finetunen (hoofdstukken en vaste kopjes).

- **12:00–13:00 (1:00) – PAUZE**

- **13:00–14:00 (1:00) – Projectplan – Stakeholders & context**  
	Stakeholders (student, docent, opleiding) en de onderwijscontext beschrijven in het Projectplan.

- **14:00–15:00 (1:00) – Projectplan – Scope & doelstellingen (MoSCoW)**  
	Scope uitwerken aan de hand van de MoSCoW‑indeling (Must/Should/Could/Won’t) en eerste SMART‑doelstellingen formuleren.

- **15:00–15:45 (0:45) – Projectplan – Randvoorwaarden**  
	Belangrijkste randvoorwaarden vastleggen, zoals welke rollen er zijn, hoe afspraken gemaakt worden en welke onderdelen minimaal moeten werken.
...
- **09:00–10:00 (1:00) – Projectplan – Probleem- & pijnpuntenanalyse**  
	Minstens vijf concrete pijnpunten (voor studenten en docenten) beschrijven in de huidige situatie.
...
- **15:45–16:30 (0:45) – Projectplan – Projectplan afronden**  
	Document nalopen, consistent maken en klaarzetten als basis voor de rest van het project.

### Donderdag 7 nov

- **09:00–10:00 (1:00) – Projectplan – Detailplanning (dit document)**  
	Weekindeling (1–9) aanscherpen en afstemmen op wat er realistisch gebouwd en beschreven kan worden.
...
- **15:00–16:00 (1:00) – Projectplan – Samenvatting fase 1**  
	Korte samenvatting schrijven van de projectplanningsfase (aanpak, scope, belangrijkste keuzes).

- **16:00–16:30 (0:30) – Projectplan – Documentatie bijwerken**  
	Laatste wijzigingen in de documenten bijwerken zodat alles up‑to‑date is.

---

## Week 2 – Functioneel Ontwerp
...
## Week 3 – Technisch Ontwerp (Technisch ontwerp)
...
## Week 9 – Oplevering & (theoretische) deployment
